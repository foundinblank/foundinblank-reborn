---
title: Example Post
description: "What does it mean to enable typographer option?"
date: Jun 11 2022
---

This post has typographic examples but hmm, below it says `Enable typographer option to see result.` What does that even mean?
